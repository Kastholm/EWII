...
# --- Data & grafer som før ---
df_2024 = pd.read_json("controllers/percent_internet_option/internet_distribution_2024.json")
df_2025 = pd.read_json("controllers/percent_internet_option/internet_distribution_2025.json")
